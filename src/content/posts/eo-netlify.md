...
## 一点补充说明
1. 国内cdn解析请求源选择 **境内**，国外选择**默认**
2. 不过需要注意的是，**Netlify 免费版每月只有 100GB 流量**。  
如果想让站点更抗 D，可以考虑：
> 将上述操作的工具域名CNAME指向 **Netlify**

_（理论上是可行的，但我本人暂时还没有~~实际测试过~~）_

# 2025/12/18 已测试
结论：此方法可行
![海外CF](https://im.tiwat.cn/im/2025/12/18/1766050120097.png)